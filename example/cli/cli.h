...
void show_help()
{
    std::cout << "Usage: yloc-cli [OPTION]...\n"
           ...
           "                            see:\n"
           "                            <https://github.com/sparcityeu/yloc#yloc-modules>\n"
           ...
           "                            only include listed component-types in resulting\n"
           "                            output\n"
           "  -p, --filter-hardware-properties=PROPERTY1,PROPERTY2\n"
           "                            only include listed hardware properties in\n"
           "                            resulting output\n"
           ...
           "                            EXTENSION that is listed within the supported output\n"
           "                            formats (option -F), the EXTENSION will also\n"
           "                            determine the output-format;\n"
           "                            if FILE has no supported EXTENSION, format will\n"
           "                            default to dot\n"
           "  -f, --output-format=FORMAT\n"
           "                            specify output format;\n"
           "                            see list of supported output formats with option -F;\n"
           "                            if option -o and -f are used together,\n"
           "                            -f will determine format regardless of any\n"
           "                            file-extension\n"
